...
def resort_cols(df):
    ...
    clin_cols = ['ClinScore', 'cosmic91_Mut_ID_old', 'cosmic91_type', 'cosmic91_count', 'cosmic70_ID', 'cosmic70_freq', 'cosmic70_type', 'cosmic70_score', 'CLNALLELEID', 'CLNDN', 'CLNSIG', 'clinvar_score', 'icgc29_ID', 'icgc29_freq']
    pop_col = cols[11:14]
